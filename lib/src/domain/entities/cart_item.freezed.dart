...
abstract class $CartItemCopyWith<$Res> {
  ...
  @useResult
  $Res call({ProductEntity productEntity, int quantity});
...
class _$CartItemImpl implements _CartItem {
  const _$CartItemImpl({required this.productEntity, required this.quantity});
  ...
  @override
  String toString() {
    return 'CartItem(productEntity: $productEntity, quantity: $quantity)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, productEntity, quantity);
...
abstract class _CartItem implements CartItem {
  const factory _CartItem(
      {required final ProductEntity productEntity,
